...
public class ReaderController {
    ...
    public ModelAndView allBooks(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "5") int size) {
        List<ReaderInfo> readers = readerInfoService.readerInfos(page,size);
        //2数据传到分页
