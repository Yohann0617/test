        ...
        <div class="panel-body">
            <form action="reader_edit_do.html?readerId=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="birth" id="birth"  value="${readerInfo.birth}(格式:1999-1-1)" >
                </div>
                <div class="input-group">
...
<%--                <input type="submit" value="确定" class="btn btn-success btn-sm" class="text-left">--%>
                <button type="submit" value="确定" class="btn btn-primary btn-lg btn-block" class="text-left">确定</button>
                <script>
